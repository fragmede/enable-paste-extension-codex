...
- Hosted payment add-card modals can tokenize a card and advance the parent transaction page unexpectedly. On live purchase or offer pages, use a nontransactional test page whenever possible; otherwise require explicit confirmation before each click or keystroke that might submit, save, tokenize, or accept terms.
